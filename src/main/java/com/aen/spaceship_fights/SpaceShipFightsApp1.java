...
public class SpaceShipFightsApp1 extends GameApplication {
    private ChatServiceFXGL chatUI;
...
//            showMessage("You have failed... But warriors rise again!", getGameController()::gotoGameMenu);
    ...
    protected void initUI() {
        chatUI = new ChatServiceFXGL("localhost", 12345);

        chatUI.setTranslateX(10);
        chatUI.setTranslateY(300);

        getGameScene().addUINode(chatUI);

        Button chatButton = new Button("Chat");
        chatButton.setOnAction(e -> chatUI.toggleVisibility());
        chatButton.setTranslateX(100);
        chatButton.setTranslateY(100);
